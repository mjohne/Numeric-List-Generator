...
{
	/// <summary>Represents the About Box form of the application.</summary>
	...
	internal sealed partial class AboutBoxForm : Form
	{
		...
		/// <summary>Initializes a new instance of the <see cref="AboutBoxForm"/> class.
		/// Sets the text of the labels to the corresponding assembly information.</summary>
		public AboutBoxForm()
		{
			InitializeComponent();
		...
		/// <summary>Handles the Load event of the AboutBoxForm control.
		/// Initializes the status bar text to an empty string.</summary>
